...
public final class LinkedBag<T> implements BagInterface<T>
{
   ...
   public BagInterface<T> union(BagInterface<T> anotherBag){
      LinkedBag<T> unionedBag = new LinkedBag<T>();

      Node currentNode = firstNode;
      while(currentNode != null){
         unionedBag.add(currentNode.data);
         currentNode = currentNode.next;
      }
   ...
   public BagInterface<T> intersection(BagInterface<T> anotherBag){
      LinkedBag<T> intersectionedBag = new LinkedBag<T>();
      LinkedBag<T> copyAnotherBag = new LinkedBag<T>();

      Node currentNode = firstNode;
      while(currentNode != null){
         if(anotherBag.contains(currentNode.data)){
            intersectionedBag.add(currentNode.data);
